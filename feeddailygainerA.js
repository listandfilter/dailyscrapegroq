...
import { getStockandNameFromCSV } from './parsecsvgg.js';
puppeteer.use(StealthPlugin());

import axios from 'axios'


const wpApiUrl='https://profitbooking.in/wp-json/scraper/v1/stockedge-dailygainer-investigator'
...
export async function feeddailygainer() {
  try {
